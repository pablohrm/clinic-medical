...
procedure TDM.tbPacienteAfterInsert(DataSet: TDataSet);  //Após clicar o botao do + ele dispara esse codigo abaixo
begin
    //Data_Cadastro vai receber o comando Date() que serve para pegar a hora do windows.
