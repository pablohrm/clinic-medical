...
begin
  ...
  //cadastrado na tabela, indicamos nome o do campo que quero buscar, qual é a informação que quero busca dentro da caixa
  // txtBusca é oq quero buscar no campo nome da tabela pacientes
